...
import {
  ...
  import { menuItemMulterConfig } from 'src/common/config/multer.config';
  import { CreateMenuItemDto } from 'src/modules/menu-item/dto/create-menu-item.dto';
  import { UpdateMenuItemDto } from 'src/modules/menu-item/dto/update-menu-item.dto';
  
  @ApiTags('Menu Items')
  @Controller('menu-manager')
  export class MenuItemManagerController {
    ...
    async update(
      ...
      @UploadedFile() file?: Express.Multer.File,
        ...
        console.log('Received updateMenuItemDto:', updateMenuItemDto);

...
import { AuthHelpers } from '../../../common/helpers/auth.helpers';
...
export class AuthService {
  ...
  async login(
    ...
    try {
      ...
      AuthHelpers.setAuthCookies(response, { accessToken, refreshToken }, process.env.NODE_ENV);
      ...
      throw AuthHelpers.handleAuthError(this.logger, error);
    }
  }
  ...
  async verifyEmail(
    ...
    try {
      ...
      throw AuthHelpers.handleVerificationError(this.logger, error);
    }
  }
